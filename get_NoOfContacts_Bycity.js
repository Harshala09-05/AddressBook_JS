...
class AddressBookMain {
    ...
    countByCity = contact => {
        return contact.reduce((acc, contact) => {
...
addressBookMain.showAllContacts(addressBookName);      // Display all contacts again

// Example of accessing count methods
const city = prompt('Enter city to count contacts: ');
const state = prompt('Enter state to count contacts: ');

// Ensure you have an instance of AddressBookSystem
const addressBookSystem = addressBookMain.addressBookSystem;

// Calling count methods
console.log(`Count by city (${city}):`, addressBookSystem.countByCity(city));
console.log(`Count by state (${state}):`, addressBookSystem.countByState(state));
