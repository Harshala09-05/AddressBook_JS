...
// Search by city and state across multiple address books
const city = prompt('Enter city to search for contacts: ');
addressBookMain.searchByCity(city);

const state = prompt('Enter state to search for contacts: ');
